            ...
            <div class="col-lg-12 box">
                <div class="form-inline">
                    ...
                    <div class=" form-group">
                        ...
                        <input type="text" class="form-control" id="keyword" v-model="keyword" v-on:keyup.enter="filter">
                    </div>
                    <div class=" form-group">
...
<script>
    var getData = async function (vue, changeRoute) {
        ...
        if (changeRoute) {
            vue.$router.push({ path: '/logs', query: data });
        }
        let response = await vue.$http.get('api/logs', { params: data });
